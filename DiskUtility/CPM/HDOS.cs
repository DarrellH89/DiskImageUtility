...
namespace HDOS
{
    public class HDOSFile
    {
        ...
        // 0.Disk type, 1.# Track, 2. Sectors per Track, 3. Groups, 4. SPG 5. Available Sectors, 6. Size
       public int[,] DiskType =
        {
            // 0    1  2    3   4   5    6  
            {0x6b, 80, 16, 255, 10, 2550, 655360 }, // 1 640k H37 96tpi DD DS
            {0x00, 80, 16, 213, 6,  1278, 327680}, //  2 320k H37 96tpi DD SS
            {0x60, 40, 10, 200, 2,  400,  102400}, //   7 100k H37 48tpi DD SS
        ...
        public class DirList : IComparable<DirList>
        {
            ...
            public DirList(string tFname, int tFsize, string tFlags, int tuser, int fgroup, int lgroup, int lastgroupsector)
            {
                fname = tFname;
                fsize = tFsize;
                userArea = tuser;
        ...
        public void ReadHdosDir(string diskFileName, ref int diskTotal)
        {
            ...
            diskVolType = buf[diskInfoStart+8];      // 0 = Data Volume Only, 1 = System Volume, 2 = Volume has no directory
